/**
 * @file	agency.h
 * @brief	Creating class Agency, responsable for managing Checking_Account operations. 		    
...
class Agency
{
	...
	public:
		...
		/**
		 * @brief This function ask for the necessary parameters to create a Checking_Account object.
		 *		  Then, it verifies if there's already in accounts an object with the same number.
		 *		  If so, shows error message. Otherwise, adds object to attribute accounts.
		 */
		void createAccount();
		...
		/**
		 * @brief This function deletes the Checking_Account object with the given account number
		...
		/**
		 * @brief This function checks and prints the balance of a Checking_Account object with the given
		...
		/**
		 * @brief This function checks and prints the available limit of a Checking_Account object
		...
		/**
		 * @brief This function withdrawls money from a Checking_Account object. Given a certain ammount
		...
		/**
		 * @brief This function increments money in a Checking_Account object. Given a certain ammount
		 ...
		 * 		  on Checking_Account object, printing all attributes of its Transaction vector.
		 */		
